...
public class day8 {
    ...
    public static int exerciseOne(boolean exOne) throws FileNotFoundException {
        ...
        for (String strings : input) {
            ...
            for (String string : answer) {
                String result = "";
                for (int i = 0; i < string.length(); i++)
                    if (string.charAt(i) == segments[0])
                        result += "a";
                    else if (string.charAt(i) == segments[1])
                        result += "b";
                    else if (string.charAt(i) == segments[2])
                        result += "c";
                    else if (string.charAt(i) == segments[3])
                        result += "d";
                    else if (string.charAt(i) == segments[4])
                        result += "e";
                    else if (string.charAt(i) == segments[5])
                        result += "f";
                    else if (string.charAt(i) == segments[6])
                        result += "g";
    ...
    private static int decodeString(String input) {
        ...
        if (new String(charArray).equals("abcefg"))
            return 0;
        else if (new String(charArray).equals("acdeg"))
            return 2;
        else if (new String(charArray).equals("acdfg"))
            return 3;
        else if (new String(charArray).equals("abdfg"))
            return 5;
        else if (new String(charArray).equals("abdefg"))
            return 6;
        else if (new String(charArray).equals("abcdfg"))
            return 9;
        else
            return -1;
    }
